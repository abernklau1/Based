...
if(isCompiled == GL_FALSE)
{
  ...
  BSD_CORE_ERROR("{0}", infoLog.data());
  BSD_CORE_ASSERT(false, "Vertex shader compilation failure")
  return;
	}
...
if (isCompiled == GL_FALSE)
{
	...
	BSD_CORE_ERROR("{0}", infoLog.data());
  BSD_CORE_ASSERT(false, "Fragment shader compilation failure")
  return;
}
