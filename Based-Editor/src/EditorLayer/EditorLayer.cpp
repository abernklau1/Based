...
namespace Based
{
    ...
    void EditorLayer::OnUpdate( Timestep ts )
    {
        ...
        Renderer2D::DrawQuad( { 0.0f, 0.0f }, { 1.0f, 1.0f }, { 0.8f, 0.3f, 0.2f, 1.0f } );
        Renderer2D::DrawQuad( { 0.0f, 0.0f, -0.1f }, { 20.0f, 20.0f }, m_CheckerboardTexture, 1.0f );
        Renderer2D::DrawQuad( { -1.0f, -1.0f }, { 1.0f, 1.0f }, { 0.3f, 0.2f, 0.8f, 1.0f } );

        Renderer2D::DrawRotatedQuad( { -2.f, -0.5f, 0.0f },
                                     { 1.0f, 1.0f },
